...
export const DrawerLayout = ({isLoading, onClose, open, children, title, slidePosition, contentPosition}: IDrawerLayout) => {
    return (
        <Drawer onClose={onClose} open={open} contentPosition={contentPosition}
